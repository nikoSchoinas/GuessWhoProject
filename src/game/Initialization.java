...
public final class Initialization {
	...
	public static void setFaces(){
		...
		Face fac11 = new Face(false,true,false,false,false,false,true,false,false,false,false,false,11); //Ελισάβετ - 11 //Να γινουν ξανθα μαλλια
		...
		Face fac16 = new Face(false,false,true,false,true,false,false,true,false,false,false,true,16); //Ιάσων - 16 //Να αλλαξουμε το στομα -> κλειστό
